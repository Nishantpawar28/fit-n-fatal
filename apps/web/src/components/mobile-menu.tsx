  ...
  return (
    <>
      <button
        ...
        className="md:hidden text-fnf-text p-1.5 -ml-1.5"
          ...
          <div className="fixed inset-0 z-40 md:hidden">
            ...
            <div className="fnf-animate-in absolute left-0 top-0 bottom-0 w-72 bg-fnf-surface border-r border-purple-500/10 p-5 overflow-y-auto">
              <div className="flex items-center justify-between mb-6">
                ...
                <button
                  onClick={() => setOpen(false)}
                  className="text-fnf-muted hover:text-fnf-text"
                >
                  <X size={20} />
                </button>
              </div>
              ...
              >
                <button
                  type="submit"
                  className="flex items-center gap-2 text-fnf-muted text-sm hover:text-fnf-text px-3 py-2"
                >
